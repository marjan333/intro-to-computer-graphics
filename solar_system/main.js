var pointLight, sun, moon, earth, mars, jupiter, mercury, neptune, pluto, saturn, uranus, venus, earthOrbit, ring, controls, scene, camera, renderer, scene;
var planetSegments = 48;
var mercuryData = constructPlanetData(360, 0.030, 20, "mercury", "img/mercury.jpg", 0.2, planetSegments);
var venusData = constructPlanetData(360, 0.030, 25, "venus", "img/venus.jpg", 0.5, planetSegments);
var earthData = constructPlanetData(365.2564, 0.015, 30, "earth", "img/earth.jpg", 0.8, planetSegments);
var moonData = constructPlanetData(29.5, 0.01, 2.8, "moon", "img/moon.jpg", 0.4, planetSegments);
var marsData = constructPlanetData(360, 0.030, 40, "mars", "img/mars.jpg", 0.8, planetSegments);
var jupiterData = constructPlanetData(360, 0.030, 45, "jupiter", "img/jupiter.jpg", 2.5, planetSegments);
var saturnData = constructPlanetData(360, 0.030, 50, "saturn", "img/saturn.jpg", 2, planetSegments);
var uranusData = constructPlanetData(360, 0.030, 55, "uranus", "img/uranus.jpg", 1.25, planetSegments);
var neptuneData = constructPlanetData(360, 0.030, 60, "neptune", "img/neptune.jpg", 1.2, planetSegments);
var plutoData = constructPlanetData(360, 0.030, 80, "pluto", "img/pluto.jpg", 0.25, planetSegments);
...
function createVisibleOrbits() {
  ...
  mercury = getRing(mercuryData.distanceFromAxis + orbitWidth
  ...
  venus = getRing(venusData.distanceFromAxis + orbitWidth
...
audioLoader.load( 'img/space.mp3', function( buffer ) {
